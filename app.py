...
from forms import UserAddForm, UserEditForm, LoginForm, MessageForm, LikeForm
...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://13139:flask@localhost/Twitter"
...
def unlike_message(message_id):
    ...
    if not existing_like:
        flash("You haven't liked this message yet.", "warning")
        return redirect(url_for('homepage'))  # Redirect to homepage or wherever appropriate
